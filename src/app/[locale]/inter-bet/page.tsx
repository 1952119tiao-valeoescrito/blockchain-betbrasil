...
import { Zap, ShieldCheck, ArrowRight, Gem, Target } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-yellow-500 selection:text-black overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 pt-32 pb-20 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* BASIC */}
          <div className="bg-slate-900/40 border-2 border-slate-800 rounded-[2.5rem] p-8 md:p-12 hover:border-blue-500/30 transition-all flex flex-col relative overflow-hidden group">
            ...
            <h2 className="text-3xl font-black text-white mb-4 text-left uppercase tracking-tight">{t('basicTitle')}</h2>
            <p className="text-gray-400 text-left mb-8 text-sm md:text-base leading-relaxed">{t('basicDesc')}</p>
            ...
            <Link href="/apostas" className="mt-auto">
               <button className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 group-hover:bg-blue-600 group-hover:text-white">
          ...
          {/* PRO */}
          <div className="bg-slate-900/40 border-2 border-slate-800 rounded-[2.5rem] p-8 md:p-12 hover:border-yellow-500/30 transition-all flex flex-col relative overflow-hidden group">
            ...
            <h2 className="text-3xl font-black text-white mb-4 text-left uppercase tracking-tight">{t('proTitle')}</h2>
            <p className="text-gray-400 text-left mb-8 text-sm md:text-base leading-relaxed">{t('proDesc')}</p>
            ...
            <Link href="/apostas" className="mt-auto">
               <button className="w-full bg-yellow-500 hover:bg-yellow-400 text-black font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(234,179,8,0.2)]">
