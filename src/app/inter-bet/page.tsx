...
import React, { useState } from 'react'; // Adicionei useState para o menu mobile
import Link from 'next/link';
import Image from 'next/image'; 
import { ArrowLeft, CheckCircle2, Gem, Zap, Menu, X } from 'lucide-react';
      ...
      <nav className="fixed top-0 left-0 right-0 bg-[#0b0c10]/90 backdrop-blur-md border-b border-[#2a2d35] z-50">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                <Link href="/">
                    <button className="hidden md:flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-white transition-colors">
        ...
        {mobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-[#0b0c10] border-b border-[#2a2d35] p-6 flex flex-col gap-4 md:hidden shadow-2xl animate-in slide-in-from-top-5">
             <Link href="/" className="text-lg font-medium text-gray-300">Início</Link>
