    ...
    <div className="fixed inset-0 z-[200] bg-[#020617] flex items-center justify-center p-4 overflow-y-auto">
      ...
      <div className="max-w-3xl w-full bg-slate-900/80 backdrop-blur-2xl border border-yellow-500/20 rounded-[3rem] p-8 md:p-16 relative shadow-[0_0_100px_rgba(0,0,0,1)] animate-in fade-in zoom-in-95 duration-500">
        ...
        <footer className="mt-12 flex flex-col md:flex-row items-center justify-center gap-6">
          <button onClick={handleClose} className="w-full md:w-auto bg-yellow-500 hover:bg-yellow-400 text-black font-black px-12 py-5 rounded-2xl shadow-[0_0_30px_rgba(234,179,8,0.3)] transition-all transform hover:scale-105 uppercase tracking-widest flex items-center justify-center gap-3">
            {t('btnAccept')} <ArrowRight size={20} />
          </button>
          <button onClick={handleClose} className="text-gray-500 hover:text-white text-xs font-bold uppercase tracking-widest underline decoration-gray-700">
            {t('btnSkip')}
          </button>
        </footer>
