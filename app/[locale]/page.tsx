// components/BlockchainBetBrasil.tsx
"use client";
...
const BlockchainBetBrasil = () => {
  ...
  const handleConnectWallet = async () => {
    try {
      ...
      console.log('🎉 Carteira conectada com sucesso! Pronto para interagir na Ethereum Mainnet.');
    } catch (error) {
      console.error('Erro ao conectar carteira:', error);
      console.log('Erro ao conectar carteira. Verifique se o MetaMask está instalado.');
    }
  };
  ...
  const handleInteract = () => {
    ...
    console.log('Pronto para interagir com a plataforma na Ethereum Mainnet!');
  };
    ...
    <>
      <div className="min-h-screen bg-slate-950 font-sans text-slate-100 relative overflow-hidden">
        ...
        <div className="relative z-10"> {/* Conteúdo principal acima do fundo */}
          ...
          <nav className="fixed top-0 left-0 right-0 bg-slate-900/80 backdrop-blur-md border-b border-emerald-700 z-50 shadow-lg">
            <div className="container mx-auto px-4">
              <div className="flex items-center justify-between h-16">
                <a href="/" className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-gradient-to-r from-emerald-500 to-green-500 rounded-lg flex items-center justify-center shadow-md">
                ...
                <div className="hidden md:flex items-center space-x-8">
                  <a href="/como-jogar" className="text-slate-300 hover:text-emerald-300 transition-colors text-lg font-medium">Como Proceder</a>
                  <a href="/apostas" className="text-slate-300 hover:text-emerald-300 transition-colors text-lg font-medium">Game</a>
                  <a href="/premiacao" className="text-slate-300 hover:text-emerald-300 transition-colors text-lg font-medium">Premiação</a>
                  <a href="/admin" className="text-slate-300 hover:text-emerald-300 transition-colors text-lg font-medium">Painel Admin</a>
                </div>

                <div className="hidden md:flex items-center space-x-4">
                  <button
                    onClick={handleConnectWallet}
                    className={`flex items-center gap-2 px-6 py-2 rounded-full transition-all duration-300 font-semibold text-lg shadow-xl ${
                      isWalletConnected
          ...
          <main className="pt-24 pb-16"> {/* Aumentado pt para acomodar a navbar fixa e dar mais espaçamento */}
            <div className="container mx-auto p-4 md:p-6 flex justify-center">
              <div className="w-full flex flex-col items-center justify-center gap-12 max-w-7xl">
                ...
                <div className="w-full max-w-5xl mx-auto bg-amber-400/90 border-b-4 border-amber-500 p-5 rounded-lg shadow-xl ring-4 ring-amber-500/50 animate-pulse-slow">
                ...
                <section className="w-full max-w-5xl flex flex-col items-center justify-center text-center gap-6" id="inicio">
                  ...
                  <div id="premiacao" className="mt-8 w-full flex flex-col md:flex-row justify-center items-stretch gap-8 px-4">
                    <div className="bg-blue-600/60 text-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center flex-1 transition-transform transform hover:scale-[1.02] border-4 border-blue-500 backdrop-blur-sm">
                    ...
                    <div className="bg-purple-700/60 text-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center flex-1 transition-transform transform hover:scale-[1.02] border-4 border-purple-500 backdrop-blur-sm">
                ...
                <section className="w-full max-w-6xl mt-16 p-8 bg-slate-800/60 rounded-3xl shadow-2xl border-2 border-emerald-600 backdrop-blur-md" id="invest-bet">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="flex flex-col items-center text-center p-6 bg-slate-700/70 rounded-2xl shadow-lg border border-emerald-500 hover:shadow-emerald-500/40 transition-shadow duration-300 transform hover:-translate-y-2 animate-fade-in delay-100 backdrop-blur-sm">
                      <div className="mb-6 w-32 h-32 flex items-center justify-center rounded-full bg-slate-900 border-4 border-emerald-400">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M11 4a2 2 0 110 4h2a2 2 0 110 4h-2a2 2 0 110 4h2a2 2 0 110 4M4 12H3m18 0h-1M6 12H4m10 0h2m-2 0h-2M4 6h.01M4 18h.01M18 6h.01M18 18h.01" />
                        </svg>
                      </div>
                    ...
                    <div className="flex flex-col items-center text-center p-6 bg-slate-700/70 rounded-2xl shadow-lg border border-emerald-500 hover:shadow-emerald-500/40 transition-shadow duration-300 transform hover:-translate-y-2 animate-fade-in delay-200 backdrop-blur-sm">
                      <div className="mb-6 w-32 h-32 flex items-center justify-center rounded-full bg-slate-900 border-4 border-emerald-400">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <div className="flex flex-col items-center text-center p-6 bg-slate-700/70 rounded-2xl shadow-lg border border-emerald-500 hover:shadow-emerald-500/40 transition-shadow duration-300 transform hover:-translate-y-2 animate-fade-in delay-300 backdrop-blur-sm">
                      <div className="mb-6 w-32 h-32 flex items-center justify-center rounded-full bg-slate-900 border-4 border-emerald-400">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
          ...
          <footer className="bg-slate-900/80 border-t border-emerald-700 py-8 mt-16 shadow-inner relative z-10">
        ...
        </div> {/* Fim do conteúdo principal relativo ao fundo */}
      </div>
    </>
  );
};
